...
start_date = "2024-09-01"  # Start date for contributions (last three months)
end_date = "2024-09-30"  # End date for contributions
commits_per_day = 35  # Number of commits to make per day
