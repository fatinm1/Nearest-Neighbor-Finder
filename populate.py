...
start_date = "2024-03-01"  # Start date for contributions (last three months)
end_date = "2024-04-30"  # End date for contributions
commits_per_day = 33  # Number of commits to make per day
