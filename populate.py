...
start_date = "2023-01-01"  # Start date for contributions (last three months)
end_date = "2023-12-30"  # End date for contributions
commits_per_day = 25  # Number of commits to make per day
