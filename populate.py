...
start_date = "2023-08-01"  # Start date for contributions (last three months)
end_date = "2023-08-30"  # End date for contributions
commits_per_day = 13  # Number of commits to make per day
