...
start_date = "2023-11-01"  # Start date for contributions (last three months)
end_date = "2023-11-30"  # End date for contributions
commits_per_day = 15  # Number of commits to make per day
