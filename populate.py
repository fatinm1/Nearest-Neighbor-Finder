...
start_date = "2024-07-01"  # Start date for contributions (last three months)
end_date = "2024-07-16"  # End date for contributions
commits_per_day = 67  # Number of commits to make per day
