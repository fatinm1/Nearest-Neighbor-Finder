...
start_date = "2024-08-01"  # Start date for contributions (last three months)
end_date = "2024-08-10"  # End date for contributions
commits_per_day = 65  # Number of commits to make per day
